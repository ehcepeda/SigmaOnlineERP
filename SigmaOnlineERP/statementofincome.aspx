                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <div class="text-center">
                                    <asp:Label ID="lbaccount" runat="server" Text="" Font-Bold="true"></asp:Label>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <div class="row mb-2">
                                    <div class="col-sm-8">
                                        <ul class="list-inline user-chat-nav mb-0">
                                            <asp:LinkButton ID="lkprintdetail" CssClass="btn btn-light waves-effect btn-label waves-light" runat="server"
                                                OnClientClick="setTimeout(function () {document.body.removeChild(modal);loading.style.display='none';}, 2000);ShowProgress()"
                                                OnClick="lkprintdetail_Click">
                                                <i class="bx bx-printer label-icon"></i> Imprimir listado
                                            </asp:LinkButton>
                                        </ul>
                                    </div>
                                </div>
